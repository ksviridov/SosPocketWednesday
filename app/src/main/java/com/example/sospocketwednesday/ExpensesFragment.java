 ...
 */
public class ExpensesFragment extends Fragment implements PopupMenu.OnMenuItemClickListener {

    private FloatingActionButton fab;
    private ItemAdapter adapter;
//    public List<Item> lastMonth;
...
//        if (MainActivity.appTheme == "Black"){
//            set;
//        }
...
//        AppCompatButton bSort = (AppCompatButton) sortItem.getActionView();
//        bSort.setText("Sort");
//        bSort.setBackgroundResource();
//
//        bSort.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
...
//            }
//        });
//        Button bSort = (Button) sortItem.getActionView();
//
//        bSort.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
